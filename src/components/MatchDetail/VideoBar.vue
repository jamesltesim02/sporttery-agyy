<template>
<div id="sr-widget" class="video-bar"></div>
</template>
<script>
...
export default {
  ...
  mounted() {
    if (!window.SIR) {
      ...
      link.href = '//fonts.googleapis.com/css?family=Roboto:300,400,500,700,900&subset=latin,latin-ext';
      link.rel = 'stylesheet';
      document.getElementsByTagName('head')[0].appendChild(link);

      ((a, b, c, d, e, f, g, h, i) => {
        a[e] || ( // eslint-disable-line no-unused-expressions
          i = a[e] = (...args) => { // eslint-disable-line no-multi-assign
            (a[e].q = a[e].q || []).push(args);
          },
          i.l = 1 * new Date(),
          i.o = f,
          g = b.createElement(c),
          h = b.getElementsByTagName(c)[0], // eslint-disable-line prefer-destructuring
          g.async = 1,
          g.src = d,
          g.setAttribute('n', e),
        ...
        document,
        'script',
        'https://widgets.sir.sportradar.com/713ad42ed654599df32c28e1f95b871b/widgetloader',
        'SIR',
        {
          language: getLang(),
        },
