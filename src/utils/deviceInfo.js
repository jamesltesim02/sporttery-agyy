...
// 是否是移动端
const isMobile = /(phone|pad|pod|iPhone|iPod|ios|iPad|Android|Mobile|MQQBrowser)/i.test(userAgent);
// 是否是iPhone X
const isIPhoneX = (osType === 'ios' && screen.height >= 812 && screen.width >= 375);
// 是否支持webp图片编码
...
const appInfoUserAgent = userAgent.split(' NB/');
